...
- **Enabled** - исользовать карту. Не обязателен, по умолчанию равен `1`
...
- **LayerZOrder** - порядок отображения слоёв: cлои с большим значением будут отображаться поверх слоев с меньшим значением. Не обязателен, по умолчанию равен `0`
...
[^1]: Используется упрощённый парсер kml
